      ...
      <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
          <div className="flex flex-col md:flex-row">
              <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                  <h3 className="font-bold text-2xl">DristiAI</h3>
              ...
              <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                  ...
                  <ul className="mt-4">
                      <li className="mt-2"><a href="#" className="opacity-75 hover:opacity-100">General Dentistry</a></li>
                      <li className="mt-2"><a href="#" className="opacity-75 hover:opacity-100">Cosmetic Dentistry</a></li>
                      <li className="mt-2"><a href="#" className="opacity-75 hover:opacity-100">Oral Heh</a></li>
                  </ul>
              </div>
              ...
              <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                  <h5 className="uppercase tracking-wider font-semibold text-gray-500">Were Social</h5>
